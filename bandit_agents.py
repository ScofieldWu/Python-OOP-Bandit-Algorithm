...
class BanditAgent():
    ...
    def choose_action(self):
        ...
        Returns:
            An action index.
        """
        agent_data = {'action_value_estimates': self.action_value_estimates,\
...
class SampleAverageBanditAgent(BanditAgent): # Note the inheritance
    ...
    def __str__(self):
        return "Sample-average Action-value Method"
...
class GradientBanditAgent(BanditAgent):
    ...
    def __init__(self, bandit_env, initial_estimates = 0, learning_rate = 0.1):
        ...
        self.action_counts = np.zeros(self.bandit_env.k)
        self.data = {'action_value_estimates': self.action_value_estimates,\
            'action_counts': self.action_counts}
...
class RecencyWeightedAverageBanditAgent(BanditAgent):
    """
    A Recency-weighted average bandit learner.
    ...
    def update_action_value_estimates(self, action, reward, learning_rate = 0.1):
        """
        Our constant step-size incremental update, where the learning rate
        is default at 0.1 -- Exercise 2.5
        ...
        Args:
            ...
            reward: The reward received as a result of choosing the action above
            that is used in the update equation. 
            learning_rate: constant step-size parameter
        """
        self.action_counts[action] += 1
        self.action_value_estimates[action] += learning_rate * \
            (reward - self.action_value_estimates[action])
    ...
    def __str__(self):
        return "Exponential Recency-Weighted Average Action-value Method"